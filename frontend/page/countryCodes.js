// ISO 3166-1 alpha-2 code + international calling code for every UN member state (plus Vatican City).
// Used to populate the country-code <select> next to the phone field in bookappointment.html.
const COUNTRY_CODES = [
...
// Regional-indicator flag emoji, derived from the ISO2 code so no flag data needs to be stored.
